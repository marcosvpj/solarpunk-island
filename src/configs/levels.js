...
export const LEVELS = {
  1: {
    ...
    name: "First Spark",
    description:
      "Build 1 fuel refinery + 1 material refinery, then survive 3 turns",
    ...
    // Story context
    storyIntro:
      "Your floating island needs energy to survive. Learn to convert radioactive waste into fuel and materials to keep your civilization alive.",
  ...
  2: {
    ...
    storyIntro:
      "More survivors have arrived! You must house them efficiently while managing their basic needs for water and electricity.",
  ...
  3: {
    ...
    description:
      "Create a 6-building cluster where every building gets an adjacency bonus",
    ...
    storyIntro:
      "Discover the power of thoughtful city planning. Buildings work better when placed strategically near each other.",
  ...
  4: {
    ...
    storyIntro:
      "Your automation needs have grown. Specialized drones can handle different tasks, but they require careful management and maintenance.",
  ...
  5: {
    ...
    storyIntro:
      "Resources are scarce. You must learn to thrive with minimal stockpiles, turning survival into an art of precise timing.",
...
export function isLevelUnlocked(levelId) {
  ...
  return (
    level.enabled &&
    level.requiredFeatures.every((feature) => GAME_FEATURES[feature])
  );
}
...
export function getLevelProgress(levelId) {
  ...
  return {
    ...
    missingFeatures: level.requiredFeatures.filter(
...
export function getCampaignStats() {
  ...
  const implementedFeatures = Object.values(GAME_FEATURES).filter(
    (enabled) => enabled,
  ).length;
