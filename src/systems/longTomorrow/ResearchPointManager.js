  ...
  ARCHAEOLOGIST: {
    ...
    tiers: {
      1: {
        ...
        cost: 3,
        description:
          "Hovering reveals ruin contents and all three outcomes. Memorial placement shows adjacency bonus preview.",
        unlocked: false,
      },
      2: {
        id: "master_restorer",
        ...
        cost: 5,
        description:
          'Restored buildings gain +2 levels instead of +1. 25% chance for "Ancestral" trait (disaster immunity).',
        unlocked: false,
        requires: ["keen_eye"],
      },
      3: {
        ...
        cost: 8,
        description:
          "Memorials affect entire hex ring (7 hexes) instead of adjacent (6). Can upgrade memorials for specialized bonuses.",
        unlocked: false,
  ...
  NATURALIST: {
    ...
    tiers: {
      1: {
        ...
        cost: 3,
        description:
          "Forests provide +1 material/turn generation. Preview which parks/farms become forests next session.",
        unlocked: false,
      },
      2: {
        ...
        cost: 5,
        description:
          "Manually plant forests (3 materials, 3 turns to grow). Agricultural buildings +25% efficiency when adjacent to forests.",
        unlocked: false,
      ...
      3: {
        ...
        cost: 8,
        description:
          '"Living Buildings" self-repair and grow more efficient. Buildings adjacent to 3+ forests gain "Overgrown" status (+50% efficiency).',
        unlocked: false,
  ...
  SURVIVOR: {
    ...
    tiers: {
      1: {
        ...
        cost: 4,
        description:
          "Early warning: see disasters 1 turn in advance. Disaster probability indicators during events.",
        unlocked: false,
      },
      2: {
        ...
        cost: 6,
        description:
          "Buildings share resources with neighbors during disasters. 50% chance minor disasters resolve automatically.",
        unlocked: false,
      ...
      3: {
        ...
        cost: 10,
        description:
          "Buildings auto-repair minor damage over 2-3 turns. Disaster resistance increases permanently with each survival.",
        unlocked: false,
  ...
  INNOVATOR: {
    ...
    tiers: {
      1: {
        ...
        cost: 4,
        description:
          "All buildings consume 15% less fuel. Construction costs reduced by 1 material (minimum 1).",
        unlocked: false,
      },
      2: {
        ...
        cost: 7,
        description:
          '"Multi-use" buildings with combined functions. Research labs generate +1 material per 3 turns.',
        unlocked: false,
      ...
      3: {
        ...
        cost: 12,
        description:
          '"AI-Assisted" buildings optimize efficiency automatically. "Network Nodes" share adjacency bonuses across unlimited distance.',
        unlocked: false,
...
export class ResearchPointManager {
  ...
  awardResearchPoints(achievementId, basePoints) {
    ...
    console.log(
      `[ResearchPointManager] Awarded ${actualPoints} research points for ${achievementId} (completion #${completionCount + 1})`,
    );
  ...
  purchaseResearch(treeId, tier) {
    ...
    if (!tierData) {
      console.warn(
        "[ResearchPointManager] Invalid tier:",
        tier,
        "for tree:",
        treeId,
      );
    ...
    if (tierData.unlocked) {
      console.warn(
        "[ResearchPointManager] Research already unlocked:",
        treeId,
        tier,
      );
      return false;
    ...
    if (!this.canPurchaseResearch(treeId, tier)) {
      console.warn(
        "[ResearchPointManager] Requirements not met for:",
        treeId,
        tier,
      );
      return false;
    ...
    if (this.availableResearchPoints < tierData.cost) {
      console.warn(
        "[ResearchPointManager] Insufficient research points for:",
        treeId,
        tier,
      );
      return false;
    ...
    console.log(
      `[ResearchPointManager] Purchased research: ${tree.name} - ${tierData.name}`,
    );
