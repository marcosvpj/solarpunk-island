...
import { GAME_MODES, getGameModeConfig, isValidGameMode, DEFAULT_GAME_MODE } from './GameModeConfig.js';
...
export class GameModeManager {
    constructor() {
        ...
        console.log('[GameModeManager] Initialized with default mode:', this.currentGameMode);
    }
    ...
    setGameMode(gameMode, sessionData = null) {
        ...
        console.log('[GameModeManager] Game mode changed:', previousMode, '->', gameMode);
     ...
     */
    endSession(endData = {}) {
        console.log('[GameModeManager] Ending session:', this.currentGameMode, endData);
