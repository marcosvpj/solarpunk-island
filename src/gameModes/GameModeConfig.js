...
export const GAME_MODE_CONFIG = {
    [GAME_MODES.STORY]: {
        name: 'Story Mode',
        shortName: 'Story',
        description: 'Experience discrete challenges with clear objectives and victory conditions. Perfect for learning the game mechanics.',
        longDescription: 'Story Mode offers structured gameplay with specific goals and victory conditions. Each level is self-contained with predefined challenges, resource availability, and win/loss conditions. Ideal for newcomers and players who prefer focused, objective-driven experiences.',
        features: [
    ...
    [GAME_MODES.LONG_TOMORROW]: {
        ...
        description: 'Build a living, evolving civilization where every decision creates permanent changes across multiple sessions.',
        ...
        maxMemorialPercentage: 0.30, // Maximum 30% of island can be memorialized
        soilMemoryDuration: 3, // Sessions enriched soil persists without farming
        resourceDecayRate: 0.10, // 10% decay of uncollected piles between sessions
