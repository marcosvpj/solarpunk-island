...
export class GameScreen extends BaseScreen {
  ...
  async init(data = {}) {
    ...
    console.log(
      `[GameScreen] Initializing game screen (new game: ${this.isNewGame})`,
    );
  ...
  show() {
    ...
    // Show game controls when entering game screen
  ...
  hide() {
    ...
    // Hide game controls when leaving game screen
  ...
  showGameControls() {
    ...
    if (gameControls) {
      ...
      console.log("[GameScreen] Game controls shown");
    }
  }
  ...
  hideGameControls() {
    ...
    if (gameControls) {
      ...
      console.log("[GameScreen] Game controls hidden");
    }
  }
