...
export class StartScreen extends BaseScreen {
    ...
    createMainMenuUI() {
        ...
        const storyMode = this.availableGameModes.find(mode => mode.mode === 'story');
        const longTomorrowMode = this.availableGameModes.find(mode => mode.mode === 'long_tomorrow');
        ...
        const longTomorrowButton = this.createButton(
            ...
            () => this.startGameWithMode('long_tomorrow'),
            {
                ...
                height: this.getResponsiveSize(50),
                fontSize: this.getResponsiveFontSize(16),
                color: longTomorrowMode ? longTomorrowMode.color : pixiColors.background.interactive
            }
        );
