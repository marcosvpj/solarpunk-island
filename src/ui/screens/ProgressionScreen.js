...
export class ProgressionScreen extends BaseScreen {
    ...
    createUI() {
        ...
        // Title
        const title = this.createTitle('Colony Progress', {
            x: center.x,
    ...
    createStatisticsDisplay(center) {
        ...
        statsContainer.position.set(center.x, center.y + this.getResponsiveSize(50));
    ...
    getGameStatistics() {
        ...
        return [
            ...
            { label: 'Days Survived', value: Math.floor((data.currentTurn || 1) / 4) } // 4 turns per day
        ];
    }
    ...
    createActionButtons(center) {
        ...
        buttonContainer.position.set(center.x, this.app.screen.height - this.getResponsiveSize(120));
