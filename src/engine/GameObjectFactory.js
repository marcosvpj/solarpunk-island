...
export class GameObjectFactory {
  ...
  static createBuilding(type, hex) {
    ...
    if (hex.building) {
      console.warn(
        `[GameObjectFactory] Hex (${hex.q}, ${hex.r}) already has a building`,
      );
      return null;
    }
    ...
    try {
      ...
      console.error(
        `[GameObjectFactory] Failed to create building: ${error.message}`,
      );
      return null;
    }
  }
  ...
  static createResource(type, hex, amount = 100) {
    ...
    if (hex.resource) {
      console.warn(
        `[GameObjectFactory] Hex (${hex.q}, ${hex.r}) already has a resource`,
      );
      return null;
    }
    ...
    try {
      ...
      console.log(
        `[GameObjectFactory] Created ${type} resource (${amount}) at (${hex.q}, ${hex.r})`,
      );
      return resource;
    } catch (error) {
      console.error(
        `[GameObjectFactory] Failed to create resource: ${error.message}`,
      );
      return null;
    }
  }
  ...
  static createUnit(type, hex, ownerBuilding = null) {
    ...
    if (hex.unit && type !== "drone") {
      console.warn(
        `[GameObjectFactory] Hex (${hex.q}, ${hex.r}) already has a unit`,
      );
    ...
    try {
      ...
      console.log(
        `[GameObjectFactory] Created ${type} unit at (${hex.q}, ${hex.r})`,
      );
      return unit;
    } catch (error) {
      console.error(
        `[GameObjectFactory] Failed to create unit: ${error.message}`,
      );
      return null;
    }
  }
  ...
  static removeBuilding(hex) {
    ...
    console.log(
      `[GameObjectFactory] Removed ${building.type} building from (${hex.q}, ${hex.r})`,
    );
    return true;
  }
  ...
  static removeResource(hex) {
    ...
    console.log(
      `[GameObjectFactory] Removed ${resource.type} resource from (${hex.q}, ${hex.r})`,
    );
    return true;
  }
  ...
  static removeUnit(hex) {
    ...
    console.log(
      `[GameObjectFactory] Removed ${unit.type} unit from (${hex.q}, ${hex.r})`,
    );
    return true;
  }
