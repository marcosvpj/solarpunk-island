...
export class GameStateManager {
    ...
    setupEventListeners() {
        ...
        EventBus.on('factory:resourceCreated', this.handleResourceCreated.bind(this));
        ...
        EventBus.on('factory:resourceRemoved', this.handleResourceRemoved.bind(this));
    ...
    handleBuildingCreated(data) {
        ...
        console.log(`[GameStateManager] Registered building ${building.id} (${building.type})`);
    }
    ...
    handleResourceCreated(data) {
        ...
        console.log(`[GameStateManager] Registered resource ${resource.id} (${resource.type})`);
    }
    ...
    handleObjectMoved(data) {
        ...
        console.log(`[GameStateManager] Updated position for ${object.type} ${object.id}`);
    }
    ...
    unregisterBuilding(building, hex) {
        ...
        console.log(`[GameStateManager] Unregistered building ${building.id} (${building.type})`);
    }
    ...
    unregisterResource(resource, hex) {
        ...
        console.log(`[GameStateManager] Unregistered resource ${resource.id} (${resource.type})`);
    }
    ...
    unregisterUnit(unit, hex) {
        ...
        console.log(`[GameStateManager] Unregistered unit ${unit.id} (${unit.type})`);
    }
    ...
    getBuildingsByLevel(level) {
        return this.getAllBuildings().filter(building => building.level === level);
    }
    ...
    getResourcesAboveThreshold(threshold) {
        return this.getAllResources().filter(resource => resource.amount >= threshold);
    }
