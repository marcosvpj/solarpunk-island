...
export class BaseCondition {
    constructor(config, gameState, playerStorage) {
        ...
        console.log(`[BaseCondition] Created ${this.getType()} condition:`, this.getDescription());
    }
     ...
     */
    onFirstMet() {
        console.log(`[${this.getType()}] Condition first met on turn ${this.firstMetTurn}: ${this.getDescription()}`);
    }
     ...
     */
    onLost() {
        console.log(`[${this.getType()}] Condition lost on turn ${this.gameState.currentTurn}: ${this.getDescription()}`);
    }
    ...
    reset() {
        ...
        console.log(`[${this.getType()}] Condition reset: ${this.getDescription()}`);
    }
    ...
    deactivate() {
        this.isActive = false;
        console.log(`[${this.getType()}] Condition deactivated: ${this.getDescription()}`);
    }
    ...
    activate() {
        this.isActive = true;
        console.log(`[${this.getType()}] Condition activated: ${this.getDescription()}`);
    }
