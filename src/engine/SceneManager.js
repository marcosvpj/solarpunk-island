...
export class SceneManager {
  ...
  setupEventListeners() {
    ...
    EventBus.on(
      "gameObject:spriteChanged",
      this.handleSpriteChanged.bind(this),
    );
  ...
  handleObjectCreated(gameObject) {
    if (this.sprites.has(gameObject.id)) {
      console.warn(
        `[SceneManager] Sprite already exists for object ${gameObject.id}`,
      );
      return;
    }
    ...
    console.log(
      `[SceneManager] Created interactive sprite for ${gameObject.type} at (${gameObject.hex.x}, ${gameObject.hex.y})`,
    );
  }
  ...
  handleObjectDestroyed(gameObject) {
    ...
    if (!sprite) {
      console.warn(
        `[SceneManager] No sprite found for destroyed object ${gameObject.id}`,
      );
      return;
    }
  ...
  handleObjectMoved(data) {
    ...
    if (!sprite) {
      console.warn(
        `[SceneManager] No sprite found for moved object ${gameObject.id}`,
      );
      return;
    }
    ...
    console.log(
      `[SceneManager] Moved ${gameObject.type} to (${newHex.x}, ${newHex.y})`,
    );
  }
  ...
  handleUnitSmoothMoved(data) {
    ...
    if (!sprite) {
      console.warn(
        `[SceneManager] No sprite found for smoothly moving unit ${unit.id}`,
      );
      return;
    }
  ...
  handleSpriteChanged(data) {
    ...
    if (!sprite) {
      console.warn(
        `[SceneManager] No sprite found for object ${gameObject.id}`,
      );
      return;
    }
    ...
    console.log(
      `[SceneManager] Changed sprite for ${gameObject.type} to ${newSpritePath}`,
    );
  }
  ...
  handleBuildingUpgraded(building) {
    ...
    console.log(
      `[SceneManager] Upgrade effect for ${building.type} level ${building.level}`,
    );
  }
