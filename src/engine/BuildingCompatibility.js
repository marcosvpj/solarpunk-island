...
import { getBuildingData, calculateBuildingCost, canAffordBuilding } from '../configs/GameData.js';
...
export function ensureBuildingProperties(building) {
    ...
    if (!building.id) building.id = `${building.type}_${building.hex.q}_${building.hex.r}`;
    ...
    if (!building.fuelConsumption) building.fuelConsumption = buildingData.fuelConsumption;
